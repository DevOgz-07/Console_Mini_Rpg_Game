...
namespace Mini_Oyun
{
    internal class Canavar_ve_Boss
    {
        public class Canavar
        {
            ...
            public Canavar(string ad, int can, int saldiriGucu, int verilenTecrube)
            {
                Ad = ad;
                MaksimumCan = can;
                Can = can;
            ...
            public virtual Oge OgeDusur()
            {
                ...
                return null; // Hiçbir öğe düşmezse
            }
        ...
        {
            public Boss(string ad, int can, int saldiriGucu, int verilenTecrube)
                : base(ad, can, saldiriGucu, verilenTecrube)
            {
        ...
        {
            public Goblin() : base("Goblin", 20, 5, 10)
            {
        ...
        {
            public Iskelet() : base("İskelet", 25, 7, 15)
            {
        ...
        {
            public Ejderha() : base("Ejderha", 400, 50, 200)
            {
        ...
        {
            public OrcReisi() : base("OrcReisi", 250 , 30, 150)
            {
